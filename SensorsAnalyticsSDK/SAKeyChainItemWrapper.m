...
NSString * const kSAService = @"com.sensorsdata.analytics.mini.SAKeyChainItemWrapper.udid";
NSString * const kSAUdidAccount = @"com.sensorsdata.analytics.mini.SAKeyChainItemWrapper.udid";
